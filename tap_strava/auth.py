...
class stravaAuthenticator(OAuthAuthenticator, metaclass=SingletonMeta):
    """Authenticator class for strava."""
    ...
    @classmethod
    def create_for_stream(cls, stream) -> stravaAuthenticator:  # noqa: ANN001
